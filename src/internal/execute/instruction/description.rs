...
lazy_static! {
    pub static ref INSTRUCTIONS: HashMap<&'static str, Description> = {
        ...
        push_description!(map, "input",         Input,          false,  false,  true,   InstructionParameter::new(Some(vec![ParameterType::Literal])));
        ...
        push_description!(map, "push",          Push,           true,   false,  true,   InstructionParameter::new(Some(vec![ParameterType::Container])), InstructionParameter::new(None), InstructionParameter::new(None));
        push_description!(map, "append",        Append,         true,   false,  true,   InstructionParameter::new(Some(vec![ParameterType::Container])), InstructionParameter::new(None), InstructionParameter::new(None));
        ...
        push_description!(map, "call",          Call,           true,   false,  true,   InstructionParameter::new(Some(vec![ParameterType::Key, ParameterType::Path])), InstructionParameter::new(None));
        push_description!(map, "call_list",     CallList,       true,   false,  true,   InstructionParameter::new(Some(vec![ParameterType::Key, ParameterType::Path])), InstructionParameter::new(Some(vec![ParameterType::List])));
